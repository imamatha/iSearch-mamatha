...
attlink='<li class="First-enabled"><a href="#" onClick="return showPage(2,'+getType+',\'previous\');"></a></li><li class="Previous-enabled"><a href="#" onClick="return showPage('+prev+','+getType+',\'previous\');"></a></li>Page:'+pagecounter+'/'+totalPage+'<li class="Next-disabled"></li><li class="Last-disabled"></li>'
}
...
attlink='<li class="First-disabled"></li><li class="Previous-disabled"></li>Page:'+pagecounter+'/'+totalPage+'<li class="Next-enabled"><a href="#" onClick="return showPage('+next+','+getType+',\'next\');"></a></li><li class="Last-enabled"><a href="#" onClick="return showPage('+lastIndex+','+getType+',\'next\');"></a></li>'
}
else
{
...
attlink='<li class="First-enabled"><a href="#" onClick="return showPage(2,'+getType+',\'previous\');"></a></li><li class="Previous-disabled"><a href="#" onClick="return showPage('+prev+','+getType+',\'previous\');"></a></li>Page:'+pagecounter+'/'+totalPage+'<li class="Next-enabled"><a href="#" onClick="return showPage('+next+','+getType+',\'next\');"></a></li><li class="Last-enabled"><a href="#" onClick="return showPage('+lastIndex+','+getType+',\'next\');"></a></li>'
}
...
paginate_discussion='<li class="First-disabled"></li><li class="Previous-disabled"></li>Page:1/'+total_page_discussion+'<li class="Next-enabled"><a href="#" onClick="return showPage(1,\'discussion\',\'next\');"></a></li><li class="Last-enabled"><a href="#" onClick="return showPage('+lastIndex+',\'discussion\',\'next\');"></a></li>'
}
